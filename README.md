...
└────────────────────────────┘
введите запрос: 1
введите новую вершину: 2345.332
┌────────────────────────────┐
│1.добавить в дерево вершину │
│2.удалить из дерева вершину │
│3.найти вершину в дереве    │
...
└────────────────────────────┘
введите запрос: 5
54.000000──────324.000000─────2345.332031
│              │              └──────────────432.234009─────465.000000
│              └──────────────54.000000──────54.000000
└──────────────43.000000
┌────────────────────────────┐
│1.добавить в дерево вершину │
...
└────────────────────────────┘
введите запрос: 5
54.000000──────432.234009─────2345.332031
│              │              └──────────────465.000000
│              └──────────────54.000000──────54.000000
└──────────────43.000000
┌────────────────────────────┐
...
└────────────────────────────┘
введите запрос: 5
54.000000──────465.000000─────2345.332031
│              │              └──────────────-0.000285
│              │                             └──────────────0.000000
│              └──────────────54.000000──────54.000000
└──────────────43.000000
